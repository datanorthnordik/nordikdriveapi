...
func TestCommunity_TableName_Coverage(t *testing.T) {
...
func TestCommunity_GetAllCommunities_Empty_OK200(t *testing.T) {
...
func TestCommunity_AddCommunities_Created201_ThenGet_OK200(t *testing.T) {
	r, _ := setupRouterWithDB(t, true)
...
func TestCommunity_AddCommunities_BadRequest400_MissingField(t *testing.T) {
	r, _ := setupRouterWithDB(t, true)
...
func TestCommunity_AddCommunities_BadRequest400_InvalidJSON(t *testing.T) {
	r, _ := setupRouterWithDB(t, true)
...
func TestCommunity_AddCommunities_BadRequest400_WrongType(t *testing.T) {
	r, _ := setupRouterWithDB(t, true)
...
func TestCommunity_GetAllCommunities_DBError500_NoMigration(t *testing.T) {
...
func TestCommunity_AddCommunities_DBError500_NoMigration(t *testing.T) {
